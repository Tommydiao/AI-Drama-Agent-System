...
ENVIRONMENT = os.getenv("DRAMA_ENV", "local").strip().lower()
DATABASE_URL = os.getenv("DRAMA_DATABASE_URL", "").strip()

POSTGRES_REQUIRED_ENVIRONMENTS = frozenset({"staging", "beta", "production"})
